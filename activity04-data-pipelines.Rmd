...
**Response**: When we set messages to TRUE we saw all of the libraries are loaded into the program. Setting it to FALSE hides that information.
...
**Response**: When the message is set to true the column specifications are visible, and when it is set to false that information is hidden.
...
**Response**: We would rank the unemployment rates, find the lowest one. Then report the major name.
...
**Response**: The major groups of Mathematics and Computer Science, Military Technologies, Botany,Soil Science, and Education Administration and Supervision all appear to have no unemployment.
...
**Response**: The majors with the higest propotion of women are in education, medical assisting, and social types of fields.
...
**Response**: There are only five jobs that earn less than the median and they have to do with the eviroment and animals. Plus there is a strange neuroscience one.
